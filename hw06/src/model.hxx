...
public:
    ...
    //
    Move const* find_move(ge211::Position) const;
    ...
    // vvv DON'T REMOVE THIS LINE, OR MY TESTS WON'T COMPILE vvv
    friend struct Test_access;
    // ^^^ DON'T REMOVE THIS LINE, OR MY TESTS WON'T COMPILE ^^^
...
private:
    ...
    {
        //move has 2 member variables 'first' (the position of the move
        // and 'second' (set of all positions gained by the move)
    }


};

git remote add origin https://github.com/Katy-Wicks111/HW6.git
